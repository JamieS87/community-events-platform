...
export default async function EventPage({
  ...
  return (
    <div className="w-full px-2 mx-auto min-h-screen">
      <div className="mx-auto max-w-4xl flex flex-col gap-y-6 my-6 w-full p-4 bg-card rounded-md shadow-sm border">
        {/* Heading */}
        ...
        <div className="flex flex-col gap-y-6">
          <div className="flex items-center">
            ...
            <h3 className="font-semibold text-xl md:text-2xl">Date and Time</h3>
          </div>
          <div className="text-black">
            <div className="text-sm font-semibold">
              <div className="text-md md:text-lg grid grid-cols-10 items-center">
                ...
                <div className="col-span-7 font-semibold text-center border border-l-0 border-b-0 rounded-br-none rounded-tr-none rounded-md rounded-tl-none rounded-bl-none px-4 py-2">
            ...
            <div className="text-sm font-semibold">
              <div className="text-md md:text-lg grid grid-cols-10 items-center">
                ...
                <div className="col-span-7 font-semibold text-center border border-l-0 rounded-md rounded-tl-none rounded-tr-none rounded-bl-none px-4 py-2">
                  <time dateTime={`${event.end_date}T${event.end_time}`}>
                    ...
                    {" - "}
                    {format(
                      parse(event.end_time, "HH:mm:ss", Date.now()),
                      "h a"
                    )}
                  </time>
                </div>
        ...
        <div className="flex flex-col gap-y-6">
          <div className="border rounded-md text-center">
            {event.pricing_model !== "payf" ? (
              <p className="text-md md:text-lg font-semibold grid grid-cols-10 min-h-full text-black">
              ...
              <div className="border rounded-md p-4">
                {event.pricing_model === "payf" && (
                  <>
                    <p className="text-md md:text-lg font-semibold text-center mb-2">
                      Choose your price
                    </p>
          ...
          {!isPurchasableEvent(event) && (
            <p className="w-full rounded-lg bg-foreground text-background p-4 text-center">
